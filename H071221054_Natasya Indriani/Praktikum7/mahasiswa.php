    ...
    <div class="mx-auto">
        <!-- <div class="card">
            ...
            <div class="card-body bg-dark bg-opacity-10">
                ...
                <?php
                    header("refresh:3;url=mahasiswa.php"); //2 detik
                }
                ?>
                <?php
                if ($sukses) {
        ...
        <div class="btn-logout">
            <a href="mahasiswa.php?op=logout" onclick="return confirm('Anda yakin mau keluar?')"><button type="button" class="btn btn-danger">Logout</button></a>
        </div>
</body>
