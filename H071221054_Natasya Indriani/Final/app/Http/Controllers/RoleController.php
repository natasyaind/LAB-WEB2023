...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            Alert::error(
                trans('roles.alert.create.title'),
                trans('roles.alert.create.message.error', ['error' => $this->getMessage()]),
            );
    ...
    public function update(Request $request, Role $role)
    {
        ...
        try {
            ...
            Alert::error(
                trans('roles.alert.update.title'),
                trans('roles.alert.update.message.error', ['error' => $this->getMessage()]),
            );
            return redirect()->back()->withInput($request->all());
        } finally {
            DB::commit();
    ...
    public function destroy(Role $role)
    {
        ...
        try {
            ...
            Alert::error(
                trans('roles.alert.delete.title'),
                trans('roles.alert.delete.message.error', ['error' => $this->getMessage()]),
            );
        } finally {
            DB::commit();
        }
