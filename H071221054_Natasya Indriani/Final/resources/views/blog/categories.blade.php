            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    ...
                    @if (file_exists(public_path($category->thumbnail)))
                        <img class="card-img-top" src="{{ asset($category->thumbnail) }}" alt="{{ asset($category->title) }}">
                    @else
                        <img class="card-img-top" src="http://placehold.it/700x400" alt="{{ asset($category->title) }}">
                    @endif
                    <!-- thumbnail:end -->
                    <div class="card-body">
                        <h4 class="card-title">
