                ...
                <div class="card-body">
                    <form action="{{ route('tags.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input id="input_tag_title" value="{{ old('title') }}" name="title" type="text" class="form-control @error('title')
                            is-invalid @enderror"
                        ...
                        <div class="form-group">
                            ...
                            <input id="input_tag_slug" value="{{ old('slug') }}" name="slug" type="text" class="form-control @error('slug')
                            is-invalid @enderror"
